...
class TasksModel(QtCore.QAbstractTableModel):
    """
    ...
    def headerData(self, section, orientation, role):
        ...
        if orientation != QtCore.Qt.Vertical:
            if (section == 0) and (role == QtCore.Qt.DisplayRole):
                ...
                return "Datum prihvatanja"
            elif (section == 6) and (role == QtCore.Qt.DisplayRole):
                return "Korisnik koji je prihvatio"
    ...
    def add(self, data : dict):
        """
        Dodaje novi zahtev (red matrice) u model.
        Pomocna metoda nase klase.
        ...
        self._data.append([data["name"], data["description"], data["label"], data["created at"]])
        self.endInsertRows()
