...
class TaskDetailsDialog(QtWidgets.QDialog):
    ...
    def __init__(self, task, task_service, parent=None):
        ...
        self.tasks_table.horizontalHeader().setVisible(False)
        self.tasks_table.verticalHeader().setVisible(True)
        self.tasks_table.verticalHeader().setSortIndicatorShown(True)
    ...
    def _populate_table(self):
        ...
        self.tasks_table.setVerticalHeaderLabels(
               ["Naziv zadatka", "Ceo opis", "Naziv labele", "Boja labele", "Autor labele", "Email autora labele", "Pozicija autora labele", "Autor zadatka", "Email autora zadatka", "Pozicija autora zadatka", "Datum kreiranja", "Datum prihvatanja", "Prihvatio korisnik", "Email prihvataca zadatka", "Pozicija prihvataca zadatka", "Status"])
